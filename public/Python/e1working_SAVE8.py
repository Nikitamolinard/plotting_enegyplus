...
class Application():
    def __init__(self, root,title,geometry):  
        ...
        #IYlim
        label2 = Label(self.root, text="Set Ylim", font=('Aerial 9'))
        label2.place(relx = 1, x =-100, y = 290, anchor = NE)
        
        self.entry= Entry(self.root, width= 8)
        self.entry.focus_set()
        self.entry.place(relx = 1, x =-40, y = 290, anchor = NE)
    ...
    def run_simulation(self):
        ...
        try : idffilename
            ...
            mylabel=Label(self.root,text='please select IDF file runned on EnergyPlus V9.4',fg='red').pack()
            return
        ...
        for f in idffilename:
            ...
            if (os.path.exists(f[:idf]+"Meter.csv")==False):
                mylabel=Label(self.root,text='No simulation found, please run the simulation on E+ V9.4',fg='red').pack()
                return
    ...
    def comfortzone(self):
        ...
        for f in idffilename:
            ...
            df2=df2.head(24)
            if (df2.empty ==True ):
                mylabel=Label(self.root,text='No the right output on E+',fg='red').pack()
                return

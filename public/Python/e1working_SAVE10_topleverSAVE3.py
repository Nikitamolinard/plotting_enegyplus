...
def main():
    ...
    # my_tree['columns']=('1','2','3')
    # my_tree.column("#0", width=0,minwidth=25)
    # my_tree.column("1", anchor=W,width=120)
    # my_tree.column("2", anchor=CENTER,width=120)
    # my_tree.column("3", anchor=W,width=120)
    
    # my_tree.heading("#0",text="label", anchor=W)
    # my_tree.heading("1",text="1", anchor=W)
    # my_tree.heading("2",text="2", anchor=CENTER)
    # my_tree.heading("3",text="3", anchor=W)

    # my_tree.insert(parent='',index='end',iid=0,text='Parent',values=("john","pizza","pep"))
    # my_tree.pack(pady=5)
